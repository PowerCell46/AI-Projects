 ...
 * reach the {@code @RestControllerAdvice} (PLAN.md step 4).
 */
public final class ErrorResponseWriter {
    ...
    public static void write(HttpServletResponse response, ObjectMapper objectMapper, HttpStatus status, String message)
            throws IOException {
